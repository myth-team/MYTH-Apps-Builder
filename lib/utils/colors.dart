...
class AppColors {
  ...
  static Color accent = const Color(0xFFF472B6);
  static Color accentLight = const Color(0xFFF9A8D4);
  ...
  static Color textLight = const Color(0xFF94A3B8);
  ...
  static Color inputFill = const Color(0xFFF1F5F9);
  static Color gradientStart = const Color(0xFF6366F1);
  static Color gradientEnd = const Color(0xFFF472B6);
}